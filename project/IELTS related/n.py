...
from fun import start_function
from fun import end_function
from fun import provider
from fun import save_file
from pathlib import Path
import sys 
import os
from rich import print
from rich.console import Console 
path1 = Path(r"C:\Users\AHMAD\OneDrive\Desktop\IELTS document\general information.rtf")
path2 = Path(r"C:\Users\AHMAD\OneDrive\Desktop\IELTS document\writing tasks.rtf")
saving_path = Path(r"C:\Users\AHMAD\OneDrive\Desktop\IELTS document\IELTS practice.txt")
...
while run:
    ...
    if section_input == "reading":
        ...
        if end <= start:
            ...
            while run and amount < end:
                ans_input= input(f'what is the answer of ({amount})?\n>>> ')
                ans_input = ans_input.strip()
                #this is how you can preven amount from increasing 
                if ans_input == "*":
                    print('skipped')
                ...
                if ans_input == "":
                    print("The answer can't be blank, answer it or skip it using '*' symbol")
                    continue
                if ans_input == "done":
                    be_saved.pop() 
                    provider(be_saved, start)
            ...
            wrong_answers = int(input("How many wrong answers have you passed? "))
            right_answers = int(input("How many right answers have you passed? "))
            plot(wrong_answers , right_answers , len(list_of_empties)) 

 
    if section_input == "writing":
    ...
    if section_input == "listening":
        print("ok")
        pass

# if user_input == "exit": (<done>)
    # exit the program and both save the answers and propert
...
# create the plot you were going to create 